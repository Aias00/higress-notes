...
```shell
  helm upgrade higress -n higress-system higress.io/higress --reuse-values --set global.onlyPushRouteCluster=false
```

### 3. 调用样例
https://github.com/cloud-router/http-call-demo
